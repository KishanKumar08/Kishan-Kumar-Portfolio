        ...
        >
          ...
          >
            ...
            <p className="text-lg text-white/70 max-w-3xl mx-auto leading-relaxed">
              Software Engineer (Backend & AI) focused on distributed system design,
              event-driven architectures, and production LLM pipelines.
              I build resilient systems with deterministic behavior,
          ...
          <motion.div
            ...
            variants={{ hidden: { y: 50, opacity: 0 }, visible: { y: 0, opacity: 1 } }}
          >
            <div className="max-w-4xl mx-auto rounded-2xl p-8 bg-white/5 border border-white/10 shadow-lg text-center">
              <p className="text-lg leading-relaxed">
                With professional experience in high-scale
                systems, I operate at the intersection of backend engineering and AI.
                My work emphasizes idempotent processing, fault tolerance,
                cost optimization, and predictable system behavior —
                ensuring systems remain stable even under peak concurrency.
              </p>
            </div>
          </motion.div>
            ...
            {['education', 'experience'].map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 flex items-center gap-2 ${isActive
              ...
              {(activeTab === 'education' ? education : experience).map((item, index) => {
                ...
                return (
                  <VerticalTimelineElement
                    ...
                    date={item.period}
                    icon={<Icon />}
                    iconStyle={{ background: '#ec4899', color: 'white' }}
                    contentStyle={{
                  ...
                  >
                    ...
                    {'description' in item && typeof item.description === 'string' ? (
                      ...
                      <ul className="space-y-3 text-white/70 leading-relaxed">
                        {(item as any).description.map((point: string, i: number) => (
